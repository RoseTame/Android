...
public class MusicService2 extends Service {
    ...
    public void sendNotity() {
        ...
        bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.gu); // 创建大图标的Bitmap (将图片复制到drawable中)
        ...
        notification = new Notification.Builder(MusicService2.this, CHANNEL_ID)
                ...
                .build(); //构建通知
        startForeground(NOTIFY_ID, notification, ServiceInfo.FOREGROUND_SERVICE_TYPE_MEDIA_PLAYBACK); //发送前台服务通知
    }
